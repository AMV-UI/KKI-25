...
class TakeBlueBoxPhoto_Execution(BaseExecution):
    """
    ...
    def initialise(self):
        ...
        self.mission_pub.publish(UInt8(data=MissionStatus.TAKE_BLUE_BOX_PHOTO.value))
...
class TakeBlueBoxPhoto_Fallback(BaseFallback):
    """
